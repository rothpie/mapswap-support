# MapSwap — Support & Privacy

Welcome! This page covers common questions, troubleshooting, and our privacy policy.
...
- **No third-party services** receive any data from the App.
...
1. Scans the visible text on webpages to find patterns that match street addresses.
2. Highlights detected addresses and makes them tappable links.
3. Opens tapped addresses in your preferred map app (Apple Maps, Google Maps, or Waze).

All processing happens locally in Safari on your device. No webpage content, addresses, or browsing data is ever transmitted off your device.
...
1. The shared text or URL is read directly from the iOS share sheet.
2. An address is extracted locally on your device.
3. The address is passed to your preferred map app via a URL scheme.

No shared content is logged, stored, or transmitted anywhere except to the map app you've chosen.
